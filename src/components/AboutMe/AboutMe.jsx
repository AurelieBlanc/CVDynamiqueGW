...
export default function AboutMe () {
    ...
    return (
        <div className="aboutMe">
            ...
            <br />
            Ma dernière experience dans le domaine de la communication fut la plus enrichissante pour moi : travaillant en autonomie, organisant et gérant la société mais aussi car j'ai eu l'occasion de travailler pendant un temps avec des développeurs web pour monter notre site web et notre ERP ; c'est là que j'ai commencé à découvrir le monde de l'informatique et sa logique.
            <br />
